...
由于此函数在应用软件中难以正确使用，建议改用 [posix_spawn(3)](../man3/posix_spawn.3.md) 或 [fork(2)](fork.2.md)。
...
如果不能调用 [execve(2)](execve.2.md)，还需注意要调用 [_exit(2)](_exit.2.md) 而非 [exit(3)](../man3/exit.3.md)，因为 [exit(3)](../man3/exit.3.md) 会刷新并关闭标准 I/O 通道，从而搞乱父进程的标准 I/O 数据结构。（即使使用 [fork(2)](fork.2.md)，调用 [exit(3)](../man3/exit.3.md) 也是错误的，因为缓冲数据会被刷新两次。）
...
[_exit(2)](_exit.2.md), [execve(2)](execve.2.md), [fork(2)](fork.2.md), [rfork(2)](rfork.2.md), [sigaction(2)](sigaction.2.md), [wait(2)](wait.2.md), [exit(3)](../man3/exit.3.md), [posix_spawn(3)](../man3/posix_spawn.3.md)
