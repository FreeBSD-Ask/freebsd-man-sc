...
**CAMGETPASSTHRU** union ccb * 此 ioctl 接受一个 XPT_GDEVLIST CCB，并返回与讨论的设备对应的直通设备。虽然此 ioctl 可通过 `pass` 驱动使用，但用途有限，因为如果调用者发出此 ioctl，他们必须已经知道讨论的设备是直通设备。通过 [xpt(4)](xpt.4.md) 设备发出此 ioctl 可能更有用。
