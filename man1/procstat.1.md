...
**`advlock`** 打印文件上的咨询锁信息。列出所有三种类型的锁：BSD 风格的 lockf(2)、POSIX 风格的 [fcntl(2)](../man2/fcntl.2.md) `F_SETLK`，以及 NFSv3 使用的远程 lockd(8) 锁。注意，`-a` 选项和 `pid` 列表都不能用于限制锁的显示，主要是因为某些类型的锁没有本地（或任何）拥有进程。
...
如果指定了 `-C` 标志，vnode 类型、引用计数和偏移字段将被省略，并包含新的能力字段，列出每个能力描述符存在的能力，如 [cap_rights_limit(2)](../man2/cap_rights_limit.2.md) 中所述。
...
**W** 此范围内的页面被 [mlock(2)](../man2/mlock.2.md) 或 [mlockall(2)](../man2/mlockall.2.md) 锁定
...
**TYPE** 锁类型，`FLOCK` 表示 [flock(2)](../man2/flock.2.md)、`FCNTL` 表示 [fcntl(2)](../man2/fcntl.2.md)、`LOCKD` 表示远程锁
...
[fstat(1)](fstat.1.md), [ps(1)](ps.1.md), [sockstat(1)](sockstat.1.md), [cap_enter(2)](../man2/cap_enter.2.md), [cap_rights_limit(2)](../man2/cap_rights_limit.2.md), [inotify(2)](../man2/inotify.2.md), [mlock(2)](../man2/mlock.2.md), [mlockall(2)](../man2/mlockall.2.md), libprocstat(3), [libxo(3)](../man3/libxo.3.md), [signal(3)](../man3/signal.3.md), [xo_options(7)](../man7/xo_options.7.md), [ddb(4)](../man4/ddb.4.md), [divert(4)](../man4/divert.4.md), [icmp(4)](../man4/icmp.4.md), [ip(4)](../man4/ip.4.md), [sctp(4)](../man4/sctp.4.md), [tcp(4)](../man4/tcp.4.md), [udp(4)](../man4/udp.4.md), [stack(9)](../man9/stack.9.md)
